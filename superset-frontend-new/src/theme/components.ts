...
export default {
  ...
  MuiButton: {
    ...
    styleOverrides: {
      ...
      contained: {
        boxShadow: 'none',
        '&:hover': { boxShadow: 'var(--mui-palette-shadow-md, 0 4px 8px rgba(0,0,0,0.12))' },
      },
      outlined: {
        borderColor: '#d0d0d0',
        '&:hover': { backgroundColor: 'rgba(0,0,0,0.04)', borderColor: '#b0b0b0' },
      },
      text: {
  ...
  MuiTableCell: {
    styleOverrides: {
      head: { fontWeight: 600, fontSize: '0.8125rem', borderBottom: '1px solid #e0e0e0' },
      body: { fontSize: '0.875rem', borderBottom: '1px solid rgba(0,0,0,0.06)' },
    },
  },
  MuiTableHead: {
    styleOverrides: {
  ...
  MuiIconButton: {
    styleOverrides: {
      root: {
        ...
        '&:hover': { backgroundColor: 'rgba(0,0,0,0.04)', transform: 'scale(1.08)' },
