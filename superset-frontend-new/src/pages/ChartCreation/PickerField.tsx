        ...
        <Box sx={{ py: 0.5 }}>
          {!hideHeader && (
            <Box sx={{ px: 2, py: 1, borderBottom: '1px solid', borderColor: 'divider', bgcolor: 'grey.50', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <Typography variant="caption" color="text.secondary">{singleSelect ? '' : `${selected.length} selected`}</Typography>
            </Box>
          )}
                  ...
                  return (
                    <Box
                      ...
                      sx={{
                        ...
                        '&:hover': { bgcolor: isSelected ? 'rgba(32, 167, 201, 0.12)' : 'action.hover' },
                    ...
                    >
                      <Box sx={{
                        ...
                        {isSelected && (
                          <Box sx={{ width: 10, height: 10, borderRadius: 0.25, bgcolor: 'primary.contrastText' }} />
                        )}
                      </Box>
          ...
          <Box sx={{ px: 2, py: 1, borderTop: '1px solid', borderColor: 'divider', display: 'flex', justifyContent: 'flex-end', bgcolor: 'grey.50' }}>
            <Chip
              label={singleSelect ? 'Done' : selected.length > 0 ? `${selected.length} selected` : 'Close'}
              size="small"
