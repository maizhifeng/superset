...
export default function AppBreadcrumbs({ items, customStatus, customLabel, onCrumbClick }: AppBreadcrumbsProps) {
  return (
    <Breadcrumbs
        ...
        crumb.isId ? (
          <Button
            ...
            sx={{
              ...
              color: i === items.length - 1 ? 'text.secondary' : 'text.disabled',
              px: 0.25,
              flexShrink: 0,
              letterSpacing: 0,
              lineHeight: 1.2,
          ...
          >
            {customStatus && i === items.length - 1 && (
              <Box component="span" sx={{ display: 'inline-block', width: 8, height: 8, borderRadius: '50%', bgcolor: customStatus === 'published' ? 'success.main' : 'warning.main', mr: 0.375, flexShrink: 0 }} />
            )}
