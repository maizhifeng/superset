...
export default function KeyboardShortcutHelpModal({ open, onClose }: KeyboardShortcutHelpModalProps) {
  ...
  const categoryOrder: ShortcutCategory[] = ['global', 'navigation', 'sql_lab', 'explore', 'dashboard', 'list_view'];
      ...
      <DialogContent dividers>
            ...
            <Box key={cat} sx={{ mb: 3 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                <Chip
                  ...
                  size="small"
                  sx={{ bgcolor: CATEGORY_COLORS[cat], color: '#fff', fontWeight: 600 }}
                />
              </Box>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', pt: 1, pb: 1 }}>
          <Button
            ...
            onClick={() => { resetAllOnboarding(); onClose(); }}
